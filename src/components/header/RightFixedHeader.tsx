...
const MobileNav: React.FC = () => {
  return (
    <div className="w-[50px] min-h-screen flex flex-col items-center text-xs justify-start pt-20 fixed font-text right-0 font-bold sm:hidden">
      ...
      <p className="[writing-mode:vertical-rl] mt-8">
        ...
        <span className="[writing-mode:horizontal-tb] h-3 my-[0px] mt-2">
          W
        </span>
        <span className="[writing-mode:horizontal-tb] h-3 my-[1px]">e</span>
        <span className="[writing-mode:horizontal-tb] h-3 my-[1px] mb-2">
          b
        </span>
        <span className="[writing-mode:vertical-rl] tracking-widest">
          コミュニティ
